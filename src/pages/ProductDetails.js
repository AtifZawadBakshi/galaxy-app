                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                  <div className="product-details-img">
                    <div className="product-thumb">
                      ...
                      >
                        <a
                          data-image="assets/images/product-detail-page/cape-dress-1.jpg"
                          data-zoom-image="assets/images/product-detail-page/cape-dress-1.jpg"
                        ...
                        >
                          <img
                            ...
                            src="assets/images/product-detail-page/cape-dress-1.jpg"
                            alt
                          />
                        </a>
                        <a
                    ...
                    <div className="zoompro-wrap product-zoom-right pl-20">
                      <div className="zoompro-span">
                        <img
                          className="zoompro blur-up lazyload"
                          data-zoom-image="assets/images/product-detail-page/cape-dress-1.jpg"
                          alt
                          src="assets/images/product-detail-page/cape-dress-1.jpg"
                        />
                    ...
                    <div className="lightboximages">
                      <a
                        href="assets/images/product-detail-page/cape-dress-1.jpg"
                        data-size="1462x2048"
                      />
                      <a
