    ...
    <div className="mobile-nav-wrapper" role="navigation">
      ...
      <ul id="MobileNav" className="mobile-nav">
        <li className="lvl1 parent megamenu">
          <a href="">
            Home <i className="anm anm-plus-l" />
          </a>
          <ul>
            <li>
              <a href="#" className="site-nav">
                Home Group 1<i className="anm anm-plus-l" />
              </a>
              <ul>
                <li>
            ...
            <li>
              <a href="#" className="site-nav">
                Home Group 2<i className="anm anm-plus-l" />
              </a>
              <ul>
                <li>
        ...
        <li className="lvl1 parent megamenu">
          <a href="#">
            Shop <i className="anm anm-plus-l" />
          </a>
          <ul>
            <li>
              <a href="#" className="site-nav">
        ...
        <li className="lvl1 parent megamenu">
          <a href="product-layout-1.html">
            Product <i className="anm anm-plus-l" />
          </a>
          <ul>
            <li>
        ...
        <li className="lvl1 parent megamenu">
          <a href="about-us.html">
            Pages <i className="anm anm-plus-l" />
          </a>
          <ul>
            <li>
              <a href="cart-variant1.html" className="site-nav">
                Cart Page <i className="anm anm-plus-l" />
              </a>
            ...
            <li>
              <a href="compare-variant1.html" className="site-nav">
                Compare Product <i className="anm anm-plus-l" />
              </a>
              <ul className="dropdown">
                <li>
                  <a href="compare-variant1.html" className="site-nav">
        ...
        <li className="lvl1 parent megamenu">
          <a href="blog-left-sidebar.html">
            Blog <i className="anm anm-plus-l" />
          </a>
          <ul>
            <li>
